...
public class RelatorioPedidos {
	...
	//Criando os métodos para vincular o nosso relatório as variáveis	
		public void gerarRelatorio(List<ListaPedido> listaDePedidos) throws JRException{
			...
			JasperPrint print = JasperFillManager.fillReport(report, null, new JRBeanCollectionDataSource(listaDePedidos));
