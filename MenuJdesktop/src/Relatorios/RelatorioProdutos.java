...
public class RelatorioProdutos {
	...
	public void gerarRelatorio(List<Produto> lista) throws JRException{
		
		
		//Fazendo a leitura das variáveis do relatório
		InputStream arq = RelatorioCliente.class.getResourceAsStream("/RelatoriosJasper/MyReports/RelatorioProdutos.jrxml");
