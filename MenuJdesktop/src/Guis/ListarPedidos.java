...
public class ListarPedidos extends JInternalFrame {
	...
	public ListarPedidos() {
		...
		JLabel lblClienteCpf = new JLabel("Condição de Pagamento");
		...
		textFieldCpf.setBounds(71, 10, 67, 20);
		...
		textFieldNomeCliente.setBounds(189, 10, 222, 20);
		...
		lblCodigo.setBounds(421, 9, 104, 20);
		panel.add(lblCodigo);
		...
		textFieldCodCliente.setBounds(519, 10, 46, 20);
		...
		lblData.setBounds(148, 9, 54, 20);
		panel.add(lblData);
		
		JLabel lblCodigo_1 = new JLabel("Codigo:");
		lblCodigo_1.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblCodigo_1.setBounds(23, 10, 54, 20);
